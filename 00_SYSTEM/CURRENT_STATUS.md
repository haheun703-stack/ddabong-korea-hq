...
- ~~YELLOW_ACTIVE 1건~~ **해소 (2026-09-13)**: `RTS_GNM_OTHER_OBJECTS_001` → 유리잔·금제 관모·가슴걸이·천마무늬 말다래 GREEN 1유형 분리 (페이지 원문 proof 저장), 원본은 BACKUP_ONLY. 유리잔·말다래 해상도 **해결** — e뮤지엄 1유형 3000px급 페이지로 출처 교체 (2026-09-13). 가슴걸이·금제 관모 e뮤지엄 이미지 크기는 편집 전 확인.
